<template>
    <div>
        ...
        <form novalidate="novalidate" onsubmit="return false;" class="searchbox sbx-amazon" data-dashlane-rid="f8da6448962368eb" data-form-type="">
        <div role="search" class="sbx-amazon__wrapper">
            <input v-model="query" type="search" name="search" placeholder="Search your favorite product" autocomplete="off" required="required" class="sbx-amazon__input" data-dashlane-rid="61da28038062dd11" data-form-type="">
            <button @click="onSearch" type="submit" title="Submit your search query." class="sbx-amazon__submit" data-dashlane-label="true" data-dashlane-rid="7e79e99c2306ee4f" data-form-type="">
